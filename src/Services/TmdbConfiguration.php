...
class TmdbConfiguration
{
    ...
    public function __construct($cnf)
    {
        ...
        $cnf['apikey'] = setting('tmdb_api_key');
        ...
        $cnf['appender']['movie'] = array('trailers', 'images', 'credits', 'translations', 'reviews', 'videos');
        $cnf['appender']['tvshow'] = array('trailers', 'images', 'credits', 'translations', 'keywords', 'videos');
