...
@section('content')
    <div class="row">
        <div class="col-md-3">
            @can('movie-directors.create')
                <x-card title="{{ __('movie::translation.add_director') }}">
                    <form action="" method="post" class="form-ajax" data-success="quickCreateSuccess" id="quick-create-form">
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary btn-block">
                                <i class="fas fa-plus"></i> {{ __('movie::translation.add_director') }}
                            </button>
                        </div>
                    </form>
                </x-card>
        ...
        <div class="col-md-9">
            <x-card title="{{ __('movie::translation.movie_directors') }}">
                {{ $dataTable->table() }}
            </x-card>
        </div>
    </div>
