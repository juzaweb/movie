...
@section('content')
    <div class="row">
        <div class="col-md-3">
            @can('movie-genres.create')
                <x-card title="{{ __('movie::translation.add_genre') }}">
                    <form action="" method="post" class="form-ajax" data-success="quickCreateSuccess" id="quick-create-form">
                        ...
                        <div class="mt-3">
                            <button type="submit" class="btn btn-primary btn-block">
                                <i class="fas fa-plus"></i> {{ __('movie::translation.add_genre') }}
                            </button>
                        </div>
                    </form>
                </x-card>
        ...
        <div class="col-md-9">
            <x-card title="{{ __('movie::translation.movie_genres') }}">
                {{ $dataTable->table() }}
            </x-card>
        </div>
    </div>
