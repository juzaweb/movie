                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="btn-group float-right">
                            ...
                            <a href="{{ route('admin.setting.video_ads') }}" class="btn btn-warning"><i class="fa fa-times-circle"></i> @lang('juzaweb::app.cancel')</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="title">@lang('juzaweb::app.url')</label>
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="baseDescription">@lang('juzaweb::app.description')</label>
                            <textarea class="form-control" name="description" id="baseDescription" rows="6">{{ $model->description }}</textarea>
                        </div>

                        <div class="form-group">
                            <label class="col-form-label" for="title">@lang('juzaweb::app.video_url')</label>
                            <div class="row">
                                <div class="col-md-10">
                                ...
                                <div class="col-md-2">
                                    <a href="javascript:void(0)" data-input="video_url" class="btn btn-primary lfm-file"><i class="fa fa-upload"></i> @lang('juzaweb::app.upload')</a>
                                </div>
                            </div>
