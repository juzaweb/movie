...
namespace Juzaweb\Movie\Http\Controllers\PaidMembers\Frontend;

use Juzaweb\Movie\Models\PaymentHistory;
use Juzaweb\Movie\Models\UserSubscription;
use Juzaweb\Movie\User;
